  ...
  if (phase === "bar") {
    return (
      <div
        ...
        tabIndex={0}
      >
        <span className="mission-bar-label" style={{ color: theme.primary }}>
          {puzzle.name}
        </span>
        <span
          className="mission-bar-sep"
  ...
  return (
    ...
    >
      ...
      <div className="mission-content">
        <p className="mission-label" style={{ color: theme.primary }}>
          Mission
        </p>
        <div
          className="gold-sep"
          style={{ width: 80, margin: "12px 0 32px" }}
        />
        <p className="mission-hook-text">{hookText}</p>
        <p className="mission-puzzle-name" style={{ color: theme.primary }}>
          {puzzle.name}
        </p>
        <button
